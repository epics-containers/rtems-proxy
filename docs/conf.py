...
release = rtems_proxy.__version__
...
# Generate anchors for headings down to level 3, so pages can cross-link to a
# specific section, e.g. [](../how-to/run-hybrid-mode.md#connect)
